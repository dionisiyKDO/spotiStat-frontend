    ...
    <form onsubmit={(e) => { e.preventDefault(); handleRegister(); }}>
      <div class="form-group">
        ...
        {#if username && username.length < 3}
          <div class="field-hint error">Username must be at least 3 characters</div>
        {/if}
      </div>
      ...
      <div class="form-group">
        ...
        {#if password && password.length < 6}
          <div class="field-hint error">Password must be at least 6 characters</div>
        {/if}
      </div>
      ...
      <button 
        type="submit" 
        disabled={loading || !passwordsMatch || password.length < 6 || username.length < 3} 
        class="register-btn"
      >
