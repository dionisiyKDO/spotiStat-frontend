    ...
    async function drawChart() {
        ...
        svg.append("path")
            ...
            .attr("d", d3.line()
                ...
                .y(function(d) { return yScale(d.total_minutes_played) })
                );
        ...
        function handleClick(event) {
            ...
            const month   = closestPoint.date.getUTCMonth() + 1; // months from 1-12
            const day     = closestPoint.date.getUTCDate();
            const year    = closestPoint.date.getUTCFullYear();
        ...
        function drawTooltip(event) {
            ...
            // Modified: Actotal_minutes_played for page scroll
            ...
            tooltip.html(`
                <div>
                    ${closestPoint.total_minutes_played} minutes played in ${d3.timeFormat("%Y-%m-%d")(closestPoint.date)}
                </div>
            `);
            ...
            circles.enter()
                ...
                .attr("cy", d => yScale(d.total_minutes_played))
